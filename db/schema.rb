...
ActiveRecord::Schema.define(version: 20141130084222) do
  ...
  add_index "stories_users", ["user_id", "story_id"], name: "index_stories_users_on_user_id_and_story_id", unique: true, using: :btree
